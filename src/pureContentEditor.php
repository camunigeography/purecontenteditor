...
{
	# Class properties
	#!# Needs to be trimmed down to state only, by keeping settings within a settings array rather than creating properties
	private $userDatabaseHeaders;
	private $permissionsDatabaseFields;
	private $user;
	private $editHostScheme;
	private $editHostName;
	private $editHostPort;
	private $liveSiteUrl;
	private $websiteName;
	private $liveSiteRoot;
	private $filestoreRoot;
	private $authTypeName;
	private $serverAdministrator;
	private $userDatabase;
	private $permissionsDatabase;
	private $changelog;
	private $textareaEditorWidth;
	private $textareaEditorHeight;
	private $richtextEditorWidth;
	private $richtextEditorHeight;
	private $richtextEditorEditorAreaCSS;
	private $richtextEditorConfigSkin;
	private $richtextEditorBasePath;
	private $richtextEditorToolbarSet;
	private $richtextEditorToolbarSetBasic;
	private $richtextEditorFileBrowser;
	private $richtextEditorPluginPaths;
	private $richtextAutoembedKey;
	private $richtextTemplates;
	private $richtextSnippets;
	private $directoryIndex;
	private $virtualPages;
	private $newPageTemplate;
	private $newPageTemplateDefaultTitle;
	private $newSubmenuTemplate;
	private $newTabsTemplate;
	private $newSidebarTemplate;
	private $messageSignatureGreeting;
	private $pureContentTitleFile;
	private $pureContentSubmenuFile;
	private $pureContentTabsFile;
	private $pureContentSidebarFile;
	private $pureContentCarouselFile;
	private $pureContentHeadermenuFile;
	private $pureContentFootermenuFile;
	private $pureContentMenuFile;
	private $enableHeaderImages;
	private $pureContentHeaderImageStore;
	private $pureContentHeaderImageFilename;
	private $pureContentHeaderImageWidth;
	private $pureContentHeaderImageHeight;
	private $pureContentHeaderThumbnailWidth;
	private $pureContentHeaderThumbnailHeight;
	private $pureContentHeaderThumbnailName;
	private $reviewPagesOpenNewWindow;
	private $maximumFileAndFolderNameLength;
	private $contentNegotiation;
	private $forcePagenameIndex;
	private $minimumUsernameLength;
	private $databaseTimestampingMode;
	private $enableAliasingChecks;
	private $allowIndexAliasOverwriting;
	private $hideDirectoryNames;
	private $wordwrapViewedSubmittedHtml;
	private $bannedLocations;
	private $technicalFileLocations;
	private $allowPageCreationAtRootLevel;
	private $archiveReplacedLiveFiles;
	private $protectEmailAddresses;
	private $externalLinksTarget;
	private $imageAlignmentByClass;
	private $imageConvertAbsolute;
	private $logout;
	private $disableDateLimitation;
	private $allowNewLocation;
	private $enablePhpCheck;
	private $allImagesRequireAltText;
	private $blogs;
	private $newBlogEntryTemplate;
	private $newBlogIndexTemplate;
	private $newBlogTreeRootTemplate;
	private $lookup;
	private $bodyAttributes;
	private $bodyClassExtra;
	private $charset;
	private $helpNewWindow;
	private $makeLiveDefaultChecked;
	private $leaveLink;
	private $nofixTag;
	private $allowCurlyQuotes;
	...
	private $editSiteUrl;
	private $archiveRoot;
	private $stubFileLocation;
	private $additionalMessageWidget;
	private $page;
	private $action;
	private $attribute;
	private $users;
	...
	private $submissions;
	private $livePage;
	private $particularPage;
	private $stagingPage;
	private $pageIs404;
	private $pageIsBeingAliased;
	private $pageToUse;
	private $editableFile;
	private $editableFileContents;
	private $typeOfFile;
	private $pageContainsPhp;
	private $blogModeReminder;
	private $blogMode;
	private $isBlogTreeRoot;
	private $userCanMakeFilesLiveDirectly;
	private $userCanEditCurrentPage;
	private $actions;
...
#!# Not yet working
	...
	private function reportErrors ($errors, $privateInfo = false, $silently = false)
	{
		...
		$message .= "\n\n\nThis message was generated by user <{$_SERVER['REMOTE_USER']}> at {$_SERVER['REMOTE_ADDR']} from the following URL:\n" . $_SERVER['_PAGE_URL'];
